...
\[
\texttt{certificates/s5\_expected\_output.txt}.
\]
...
\[
\texttt{certificates/s6\_classification\_status.md}
\]
and in the companion JSON file with the same base name.  The five hard
residual-clique rows are retained only as bounded computational status and
are not used as proof of a theorem in this paper.
