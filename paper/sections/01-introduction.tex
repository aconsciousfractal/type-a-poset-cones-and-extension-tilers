...
the standard simplex triangulation of the unit cube, the order polytope
$\mathcal O(P)$ is the union of the simplices indexed by $L(P)$.  Thus an
extension-tiler factorization of $S_n$ produces a tiling of $[0,1]^n$ by
coordinate-permuted copies of $\mathcal O(P)$.  For the six-element
counterexample this gives a tiling of $[0,1]^6$ by $48$ copies of its
order polytope.
