...
The correspondence between poset cones and unions of chambers of the braid arrangement is classical: poset cones and their Whitney-number refinements of the linear-extension count are developed in~\cite{DorpalenBarryKimReiner2021}, and a comprehensive treatment of the faces and cones of a real hyperplane arrangement is given in~\cite{AguiarMahajan2017}. These are context references; no result from them is used in the proofs below.
...
\cite[Sec.~3.5]{Stanley2012}; see also the generation algorithm of
Pruesse and Ruskey~\cite{PruesseRuskey1994}:
